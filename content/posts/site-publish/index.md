...
{{< alert >}}敬请留意：此文撰写于多年以前。时过境迁，本站现已已脱离境内的网络服务框架，挂载于 Cloudflare ；本文所述内容可能仍有指引性意义，但本站或许已不采用下文的某些方式提供服务。{{</ alert >}}

{{< lead >}}此文是上一篇《关于本站的建造》的内容延伸，是关于把搭建完成的 Hugo 站点进行部署和CDN加速的教程文章。与前篇不同，这是一篇普遍适用的教程。{{</ lead >}}
